//
//  TBakeWalletProviderFactory.swift
//  iOS_tbake_dapps
//
...
struct TBakeWalletProviderFactory {
    static let policies: [String: ServerTrustPolicy] = [:]
    
    static func makeProvider() -> MoyaProvider<TBakeWalletService> {
        let manager = Manager(
        ...
        return MoyaProvider<TBakeWalletService>(manager: manager, plugins: plugins)
    }
}
