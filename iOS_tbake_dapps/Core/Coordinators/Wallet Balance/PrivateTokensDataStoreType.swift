...
protocol PrivateTokensDatastoreType {
    ...
    func addOrUpdateErc271(contract: TBakeWallet.Address, openSeaNonFungibles: [OpenSeaNonFungible], tokens: [Activity.AssignedToken], completion: @escaping () -> Void)
    ...
    func tokenObject(contract: TBakeWallet.Address) -> TokenObject?
}
