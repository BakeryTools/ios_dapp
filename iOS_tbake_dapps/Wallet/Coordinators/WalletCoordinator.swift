...
//                }
                strongSelf.delegate?.didFinish(comeFrom: "createWallet", with: wallet, in: strongSelf)
    ...
    func didCreateAccount(comeFrom: String, account: Wallet) {
        delegate?.didFinish(comeFrom: comeFrom, with: account, in: self)
        //Bit of delay to wait for the UI animation to almost finish
...
extension WalletCoordinator: ImportWalletViewControllerDelegate {
    ...
    func didImportAccount(account: Wallet, in viewController: ImportWalletViewController) {
        ...
        didCreateAccount(comeFrom: "importWallet", account: account)
    }
}
