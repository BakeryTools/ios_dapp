...
enum ButtonsBarConfiguration {
    ...
    var barButtonTypes: [ButtonsBarButtonType] {
        ...
        case .brown(let buttons):
            return (0..<buttons).compactMap { _ in .brown }
        case .custom(let types):
            return types
        case .combined(let buttons):
            let buttonsToShow: [ButtonsBarButtonType] = [.brown, .white]
...
class ButtonsBar: UIView {
    ...
    private func updateButtonsTypes() {
        ...
        for (index, combined) in zip(configuration.barButtonTypes, viewsToDisplay).enumerated() {
            ...
            case .brown:
                setup(viewModel: .brownButton, view: combined.1)
            }
        }
...
private struct ButtonsBarViewModel {
    ...
    static let brownButton = ButtonsBarViewModel(
        buttonBackgroundColor: Colors.tbakeDarkBrown,
        disabledButtonBackgroundColor: Colors.tbakeDarkBrown.withAlphaComponent(0.3),
        disabledButtonBorderColor: Colors.tbakeDarkBrown,
        buttonTitleColor: Colors.appWhite,
        buttonBorderColor: Colors.tbakeDarkBrown,
        buttonBorderWidth: 0
    )

    static let whiteButton = ButtonsBarViewModel(
        buttonBackgroundColor: Colors.backgroundClear,
        disabledButtonBackgroundColor: Colors.appWhite,
        disabledButtonBorderColor: Colors.tbakeDarkBrown.withAlphaComponent(0.3),
        disabledButtonTitleColor: Colors.tbakeDarkBrown.withAlphaComponent(0.3)
    )
    ...
    var buttonTitleColor: UIColor = Colors.tbakeDarkBrown
    ...
    var buttonBorderColor: UIColor = Colors.tbakeDarkBrown
