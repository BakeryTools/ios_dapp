...
class ActivitiesViewController: UIViewController {
    ...
    init(viewModel: ActivitiesViewModel, wallet: TBakeWallet.Address, sessions: ServerDictionary<WalletSession>, tokensStorages: ServerDictionary<TokensDataStore>) {
        ...
        title = R.string.localizable.chartTabbarItemTitle()
