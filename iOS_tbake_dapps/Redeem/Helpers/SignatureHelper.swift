...
class SignatureHelper {
    ...
    class func signatureAsHex(for message: String, account: TBakeWallet.Address, analyticsCoordinator: AnalyticsCoordinator) throws -> String? {
    ...
    class func signatureAsDecimal(for message: String, account: TBakeWallet.Address, analyticsCoordinator: AnalyticsCoordinator) throws -> String? {
