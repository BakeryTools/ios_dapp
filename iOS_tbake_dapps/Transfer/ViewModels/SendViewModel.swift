...
struct SendViewModel {
    ...
    var amountErrorLbl: String {
        return R.string.localizable.sendErrorInvalidAmount()
    }
    
    var recipientErrorLbl: String {
        return R.string.localizable.sendErrorInvalidAddress()
    }
    
    var amountErrorEmptyLbl: String {
        return R.string.localizable.sendAmountErrorEmpty()
    }
    
    var recipientErrorEmptyLbl: String {
