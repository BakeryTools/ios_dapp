...
extension TransactionConfirmationViewModel {
    ...
    private static func gasEstimatedProcessingTime(withConfigurator configurator: TransactionConfigurator) -> String {
    ...
    class SendFungiblesTransactionViewModel: SectionProtocol {
        ...
        func getGasData() -> String {
            return gasFeeString(withConfigurator: configurator, cryptoToDollarRate: cryptoToDollarRate)
        }
        
        func getGasTitle() -> String {
            return gasEstimatedProcessingTime(withConfigurator: configurator)
        }
        ...
        func getIconNetwork() -> UIImage? {
            return session.server.iconImage
        }
        
        func getNetwork() -> String {
            return session.server.displayName
        }
        
        func getOldBalance() -> String? {
            return balance
        }
        
        func getNewBalance() -> String? {
            return newBalance
        }
        
        func getRecipient() -> String? {
            return recipientResolver.value
        }
    }
